 ...
 *
 * Date:           Thu May 12 12:37:54 2016
 * Model version:  1.170
 * Matlab version: 8.1 (R2011b) 08-Jul-2011
 ****************************************************************************/
...
typedef robot_diff_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * robot_diff(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(robot_diff_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: robot_diff -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
